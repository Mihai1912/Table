...
object TestTables {
  ...
  def programmingLanguages1: Table = {
    val a = tableFunctional.newCol("Functional" , "Yes")
    val b = tableImperative.newCol("Imperative" , "Yes")
    val c = tableObjectOriented.newCol("Object-Oriented" , "Yes")

    val d = a.merge("Language" , c).get
    d.merge("Language" , b).get
  }
  // 3.2
//  val programmingLanguages2: Table = {
//    val condition = And(
//      Field("Original purpose", _ == "Application"),
//      Field("Other paradigms", _ == "concurrent")
//    )
//    programmingLanguages1.filter(condition).get
//  }

  // 3.3
//  val programmingLanguages3: Table = {
//    programmingLanguages2.select(List("Language" , "Object-Oriented" , "Functional")).get
//  }
